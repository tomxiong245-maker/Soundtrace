...
- run: `EP04-v21-20260815-1311` / `EP04`
...
- 全部候选：6（6.600 条/节目小时）；审核包：6（6.600 条/节目小时）。
- 候选类别：`{"filler_hesitation": 2, "immediate_repetition": 4}`；风险：`{"low": 6}`。
- 审核预算 / 剩余：`20` / `14`；安全阻断：`41`。
...
- 状态：`PENDING_HUMAN_REVIEW`；正式决定：0 / 6。
